...
class TelefoneView {
    public function showListTelefone($telefone) {
        ...
        for($i = 0; $i<count($telefone);$i++){
            ...
            echo "<td>".$telefone[$i]['cliente_id']."</td>";
    ...
    public function showUpdateForm($telefone) {
        ...
        echo "<form action='index.php?route=telefone&&action=update' method='POST'>
                <input type=text name='id' value='".$telefone['id']."'>
                <input type=text name='numero_telefone' value='".$telefone['numero_telefone']."'>
                <input type=text name='cliente_id' value='".$telefone['cliente_id']."'>
